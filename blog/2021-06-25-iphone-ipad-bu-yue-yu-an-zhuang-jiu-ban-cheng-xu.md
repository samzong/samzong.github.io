...
![image](images/resize,w_960,m_lfit_ca1426b2.jpg)

### Charles SSL 证书导入系统

从 Charles 中导出证书文件

![image](images/resize,w_960,m_lfit_600e8fe9.jpg)

在 KeyChain Access 中导入证书

![image](images/resize,w_960,m_lfit_b1468213.jpg)

选中导入的证书，然后右键选择 'Get Info' ，设置证书信任状态

![image](images/resize,w_960,m_lfit_6de2ffdf.jpg)
...
![image](images/resize,w_960,m_lfit_0e8e9893.jpg)
...
![image](images/resize,w_960,m_lfit_1fafec96.jpg)
...
![image](images/resize,w_960,m_lfit_93eb0061.jpg)
...
![image](images/resize,w_960,m_lfit_1e75e05a.jpg)

## 验证

下载完成后，你的 iTunes App Library 中已经有了一个虾米音乐，连接上你的手机，将其安装到手机上即可，下图是我安装后的版本截图。

![image](images/resize,w_960,m_lfit_c00cfc7a.jpg)
